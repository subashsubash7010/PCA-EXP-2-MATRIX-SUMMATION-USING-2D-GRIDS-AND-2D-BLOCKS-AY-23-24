...
```
## OUTPUT:
<img width="724" height="109" alt="image" src="https://github.com/user-attachments/assets/606eda9e-7020-4b9a-82fc-8548445b5c2e" />


## RESULT:
The host took 0.149682 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in ________ seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
